        ...
        [
            ...
            'items' => [
                [
                    ...
                    'icon' => 'cog',
                    'active_routes' => ['admin.settings.index', 'admin.settings.general.*', 'admin.settings.logo.*', 'admin.settings.siakad.*', 'admin.settings.roles.*', 'admin.settings.templates.*', 'admin.settings.backup.*'],
                    'roles' => ['super_admin', 'admin_lppm'],
                ],
                [
                    'label' => 'Sinkron User Login',
                    'route' => 'admin.settings.user-sync.index',
                    'icon' => 'sync',
                    'active_routes' => ['admin.settings.user-sync.*'],
                    'roles' => ['super_admin', 'admin_lppm'],
                ],
                [
                    ...
                    'icon' => 'community',
                    'active_routes' => ['admin.settings.users.*'],
                    'roles' => ['super_admin', 'admin_lppm'],
                ],
            ],
        ],
