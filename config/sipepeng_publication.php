...
return [
    ...
    'storage_disk' => env('PUBLICATION_STORAGE_DISK', 'local'),

    'storage_path' => 'lppm/publications',

    'uploads' => [
        'file_manuscript' => ['mimes' => ['pdf'], 'max_kb' => 10240],
        'file_acceptance_letter' => ['mimes' => ['pdf'], 'max_kb' => 5120],
        'file_published' => ['mimes' => ['pdf'], 'max_kb' => 10240],
        'file_other' => ['mimes' => ['pdf'], 'max_kb' => 5120],
    ],
    ...
    'statuses' => [
        ...
        'published_confirmed' => ['label' => 'Terbit Dikonfirmasi', 'stage' => 'published', 'color' => '#059669', 'editable' => false, 'terminal' => true],
    ],
    ...
    'transitions' => [
        ...
        'verified' => ['confirm_published' => 'published_confirmed'],
    ],
