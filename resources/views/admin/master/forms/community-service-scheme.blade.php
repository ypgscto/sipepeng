...
<label class="inline-flex items-center gap-2 text-sm text-slate-700">
    <input type="hidden" name="requires_partner" value="0">
    <input type="checkbox" name="requires_partner" value="1" @checked(old('requires_partner', $record?->requires_partner ?? true)) class="rounded border-slate-300 text-emerald-600">
    Memerlukan mitra
</label>
<div>
