<x-app-layout>
    <x-slot name="header">Antrian Verifikasi Admin</x-slot>
    <div class="sipeng-page">
        <x-sipeng.page-header title="Antrian Verifikasi Administrasi" />
            ...
            <div class="sipeng-card-body p-0">
                <table class="min-w-full text-sm">
                    <thead class="bg-slate-50"><tr>
                        ...
                        <th class="px-4 py-3 text-left">Ketua</th><th class="px-4 py-3 text-right">Aksi</th>
                    </tr></thead>
                    <tbody class="divide-y">
                        @forelse ($proposals as $proposal)
                            <tr>
                                ...
                                <td class="px-4 py-3 text-right"><a href="{{ route('admin.research.show', $proposal) }}" class="text-emerald-700 text-xs hover:underline">Verifikasi</a></td>
                            </tr>
                        @empty
